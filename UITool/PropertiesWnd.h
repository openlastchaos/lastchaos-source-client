...
enum ePROP_TYPE
{
	...
	ePROP_TEXT_COLOR,
	ePROP_TEXT_COLOR_IDLE,
	ePROP_TEXT_COLOR_ENTER,
	ePROP_TEXT_COLOR_SELECT,
	ePROP_TEXT_SHADOW,
	ePROP_TEXT_EDGE,
	...
	ePROP_CHECK_TEXT_X,
	ePROP_CHECK_REGION,
	ePROP_CHECK_COLOR_NONE,
	ePROP_CHECK_COLOR_CHECK,
	ePROP_CHECK_COLOR_NONE_DISABLE,
	ePROP_CHECK_COLOR_CHECK_DISABLE,
	ePROP_CHECK_ALIGN,
	ePROP_CHECK_EDGE,
	...
	ePROP_CHECK_NONE_DISABLE_L,
	ePROP_CHECK_NONE_DISABLE_T,
	ePROP_CHECK_NONE_DISABLE_R,
	ePROP_CHECK_NONE_DISABLE_B,

	ePROP_CHECK_CHECK_DISABLE_L,
	ePROP_CHECK_CHECK_DISABLE_T,
	ePROP_CHECK_CHECK_DISABLE_R,
	ePROP_CHECK_CHECK_DISABLE_B,
	...
	ePROP_TB_EX_SY,
	ePROP_TB_EX_GAP_Y,
	ePROP_TB_EX_SCROLL_THUMB_WIDTH,
...
private:
	void ChangeImageControlProp(LPARAM lparam);
