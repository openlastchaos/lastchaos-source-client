...
void CUICashShopEX::OpenCashShopEX()
{
	...
	pHud->HUD_SetModelData(HUD_CHARACTER_TYPE, -1, eRENDER_UI_TYPE_CASHSHOP);
...
void CUICashShopEX::CloseCashShopEX( void )
{
	((CPlayerEntity*)CEntity::GetPlayerEntity(0))->SetHudModel_Use(FALSE);
	UIMGR()->RearrangeOrder(UI_CASHSHOP_EX, FALSE);
}
